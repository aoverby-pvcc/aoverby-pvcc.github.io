...
def main():
        global out
        out = open(filename, "w")
        out.write("\n*********PIEDMONT VIRGININA COMMUNITY COLLEGE*********")
        ...
        out.close()
        print(f"To see results open file: {filename}")
...
def process_info_courses():
        global info_elect, num_info_req, num_info_elect, tot_info, all_info_courses
        temp_set = set()
...
def display_info_courses():
        out.write("\nCERTIFICATE: Associates of Applied Sciences in Information Technologies")
        out.write("\n" + dash_line)
