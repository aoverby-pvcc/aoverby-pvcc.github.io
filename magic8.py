# Name: Anton Overby
# Prog Purpose: This magic 8 ball code uses a Python tuple since the user does not have the ability to change the 8-ball answers
# However, the program could have used a Python list instead of a tuple.
# NOTE: Tuples use parenthese; lists use braces.
...
def main():
    ...
    while another_question:
        ...
        if ask_again.upper() == "N" or ask_again == "n":
